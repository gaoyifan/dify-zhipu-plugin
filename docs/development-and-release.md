...
```bash
./dify-plugin plugin package . -o zhipuai-0.1.3.difypkg
```

然后检查包内容：

```bash
unzip -l zhipuai-0.1.3.difypkg
```
...
- `https://github.com/gaoyifan/dify-zhipu-plugin/releases/tag/v0.1.3`
